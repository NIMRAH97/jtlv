// $ANTLR 3.0b8 Java.g 2007-05-03 14:05:22
...
public class JavaLexer extends Lexer {
    ...
    public final void mHexLiteral() throws RecognitionException {
        try {
            ...
            // Java.g:757:14: ( '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )? )
            // Java.g:757:14: '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            ...
            // Java.g:757:38: ( IntegerTypeSuffix )?
            int alt2=2;
    ...
    public final void mDecimalLiteral() throws RecognitionException {
        try {
            ...
            // Java.g:759:18: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )? )
            // Java.g:759:18: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )?
            {
            // Java.g:759:18: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt4=2;
            ...
            if ( (LA4_0=='0') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("759:18: ( '0' | '1' .. '9' ( '0' .. '9' )* )", 4, 0, input);
            ...
            // Java.g:759:45: ( IntegerTypeSuffix )?
            int alt5=2;
    ...
    public final void mOctalLiteral() throws RecognitionException {
        try {
            ...
            // Java.g:761:16: ( '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )? )
            // Java.g:761:16: '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            // Java.g:761:20: ( '0' .. '7' )+
            ...
            // Java.g:761:32: ( IntegerTypeSuffix )?
            int alt7=2;
    ...
    public final void mFloatingPointLiteral() throws RecognitionException {
        try {
            ...
            // Java.g:770:9: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix )
            int alt19=4;
            alt19 = dfa19.predict(input);
            switch (alt19) {
                case 1 :
                    // Java.g:770:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )?
                    {
                    // Java.g:770:9: ( '0' .. '9' )+
                    int cnt8=0;
                    loop8:
                    ...
                    break;
                case 2 :
                    // Java.g:771:9: '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )?
                    {
                    match('.'); 
                    // Java.g:771:13: ( '0' .. '9' )+
                    int cnt12=0;
                    ...
                    break;
                case 3 :
                    // Java.g:772:9: ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )?
                    {
                    // Java.g:772:9: ( '0' .. '9' )+
                    int cnt15=0;
                    loop15:
                    ...
                    break;
                case 4 :
                    // Java.g:773:9: ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix
                    {
                    // Java.g:773:9: ( '0' .. '9' )+
                    int cnt17=0;
                    loop17:
    ...
    public final void mCharacterLiteral() throws RecognitionException {
        try {
            ...
            // Java.g:783:9: ( '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            // Java.g:783:9: '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\''
            {
            match('\''); 
            // Java.g:783:14: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )
            int alt22=2;
            ...
            if ( (LA22_0=='\\') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("783:14: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )", 22, 0, input);

                throw nvae;
            }
            switch (alt22) {
                case 1 :
                    // Java.g:783:16: EscapeSequence
                    {
                    mEscapeSequence(); 
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            ...
            // Java.g:787:8: ( '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"' )
            // Java.g:787:8: '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // Java.g:787:12: ( EscapeSequence | ~ ( '\\\\' | '\"' ) )*
            loop23:
            do {
                int alt23=3;
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // Java.g:792:9: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape )
            int alt24=3;
            ...
            if ( (LA24_0=='\\') ) {
                ...
                default:
                    NoViableAltException nvae =
                        new NoViableAltException("790:1: fragment EscapeSequence : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape );", 24, 1, input);
                ...
                NoViableAltException nvae =
                    new NoViableAltException("790:1: fragment EscapeSequence : ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape );", 24, 0, input);

                throw nvae;
            }
            switch (alt24) {
                case 1 :
                    // Java.g:792:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
                    {
                    match('\\'); 
    ...
    public final void mOctalEscape() throws RecognitionException {
        try {
            // Java.g:799:9: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt25=3;
            ...
            if ( (LA25_0=='\\') ) {
                ...
                if ( ((LA25_1>='0' && LA25_1<='3')) ) {
                    ...
                    NoViableAltException nvae =
                        new NoViableAltException("797:1: fragment OctalEscape : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 25, 1, input);
                ...
                NoViableAltException nvae =
                    new NoViableAltException("797:1: fragment OctalEscape : ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) );", 25, 0, input);

                throw nvae;
            }
            switch (alt25) {
                case 1 :
                    // Java.g:799:9: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
                    {
                    match('\\'); 
                    // Java.g:799:14: ( '0' .. '3' )
                    // Java.g:799:15: '0' .. '3'
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // Java.g:806:9: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // Java.g:806:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('\\'); 
            match('u'); 
    ...
    public final void mIdentifier() throws RecognitionException {
        try {
            ...
            // Java.g:813:9: ( Letter ( Letter | JavaIDDigit )* )
            // Java.g:813:9: Letter ( Letter | JavaIDDigit )*
            {
            mLetter(); 
            // Java.g:813:16: ( Letter | JavaIDDigit )*
            loop26:
            do {
                int alt26=2;
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // Java.g:821:8: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            // Java.g:
            {
    ...
    public final void mJavaIDDigit() throws RecognitionException {
        try {
            // Java.g:838:8: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' .. '\\u096f' | '\\u09e6' .. '\\u09ef' | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' | '\\u0be7' .. '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66' .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' .. '\\u0ed9' | '\\u1040' .. '\\u1049' )
            // Java.g:
            {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            // Java.g:859:9: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // Java.g:859:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // Java.g:859:14: ( options {greedy=false; } : . )*
            loop27:
            do {
                int alt27=2;
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt30) {
            ...
            case 93 :
                ...
                break;
            case 94 :
                // Java.g:1:423: FloatingPointLiteral
                {
    ...
    class DFA19 extends DFA {
        ...
        public String getDescription() {
            return "769:1: FloatingPointLiteral : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix );";
        }
    }
