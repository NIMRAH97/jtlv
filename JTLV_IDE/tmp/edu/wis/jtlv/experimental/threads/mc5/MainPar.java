...
public class MainPar {
	...
	public static void usage(String[] args) {
		...
		try {
			...
			String mName = MainPar.class.getCanonicalName();
	...
	public static void do_parallel_trans(SMVModule main, int N, int threadNum,
		...
		ParallelMain_german main_german = new ParallelMain_german(main, N,
				threadNum, procPerThread, lastProcPerThread, verbose);
		main_german.start();
	}
}
