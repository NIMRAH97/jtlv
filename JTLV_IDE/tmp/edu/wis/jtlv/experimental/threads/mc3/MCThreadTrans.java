...
System.out.println("id=" + id + " is reading from channels");
			...
			othersGlobalTrans = False;
System.out.println("id=" + id + " is reading Home channel");
			BDD fromHome = inputChannelFromHome.read();
			if(fromHome != null){
				BDD fromHomeAdjusted = adjustBDDToManager(fromHome);
				othersGlobalTrans = (fromHomeAdjusted).and(idleTrans);
			}
...
System.out.println("id=" + id + " is reading channel of " + i);
					...
					if(temp != null){
						...
						othersGlobalTrans = othersGlobalTrans
							.or(tempLocal.and(idleTransForP));
					}
				}
			}
...
/*    //an output channel of bdds and markers
