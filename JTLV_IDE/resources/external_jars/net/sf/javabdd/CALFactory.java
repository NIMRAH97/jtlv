 ...
 * 
 * @author John Whaley
 * @version $Id: CALFactory.java,v 1.2 2009/10/18 19:30:54 uid228351 Exp $
 */
public class CALFactory extends BDDFactory {
    ...
    static {
        // String libname = "cal";
        String libname = getProperty("callib", "cal");
        try {
    ...
    private static class CALBDD extends BDD {
        ...
        public BDD relprod(BDD that, BDDVarSet var) {
            ...
            CALBDD d = (CALBDD) ((BDDVarSet.DefaultImpl) var).b;
        ...
        */
        ...
        public BDDVarSet toVarSet() {
            return new BDDVarSet.DefaultImpl(new CALBDD(this._ddnode_ptr));
        }
