 ...
 * 
 * @author John Whaley
 * @version $Id: CUDDFactory.java,v 1.2 2009/10/18 19:30:54 uid228351 Exp $
 */
public class CUDDFactory extends BDDFactory {
    ...
    static {
        //String libname = "cudd";
        String libname = getProperty("cuddlib", "cudd");
        try {
    ...
    private CUDDFactory INSTANCE;
	/* the names below should be kept consistent with those used 
	 * in cudd_jni.c in the top-level directory.
	 */
	private long info=0;   // CUDD manager
    private long zero=0;      // constant CUDD BDD zero
    private long one=0;       // constant CUDD BDD one

	/* --------------------- BEGIN native methods -------------------- */
	/* ALL native methods are declared here, so they can access
	   the fields above. Declarations in the inner classes cannot 
	   access these fields.
	*/
    ...
    private  native int setVarNum0(int num);
    private  native long ithVar0(int var);
	...
	private  native long high0(long b);
	private  native long low0(long b);
	private  native long not0(long b);
	private  native long ite0(long b, long c, long d);
	private  native long relprod0(long b, long c, long d);
	private  native long compose0(long b, long c, int var);
	private  native long exist0(long b, long c);
	private  native long forAll0(long b, long c);
	private  native long restrict0(long b, long var);
	private  native long support0(long b);
	private  native long apply0(long b, long c, int opr);
	private  native long satOne0(long b);
	...
	private  native void delRef(long p);
	private  native long veccompose0(long b, long p);
	private  native long replace0(long b, long p);
	private  native long alloc();
	private  native void set0(long p, int oldvar, int newvar);
...
///////////////////////////////////////////////////////////////////////////////
     ...
     */
    private  class CUDDBDD extends BDD {
        ...
        public int[] varProfile() {
			return varSupportIndex0(_ddnode_ptr);
            //// TODO Implement this.
            //throw new UnsupportedOperationException();
        }
        ...
        //private  native void delRef(long p);
         ...
         final boolean USE_FINALIZER = false;
