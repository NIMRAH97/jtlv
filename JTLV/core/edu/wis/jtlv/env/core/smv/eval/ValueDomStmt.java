...
public class ValueDomStmt extends ValueStmt {
	private JTLVBDDCouple coup;

	public ValueDomStmt(SMVModule a_context, JTLVBDDCouple a_coup)
	...
	public BDD biimpDomain(ValueDomStmt other) {
		...
		if (this.getBDDCouple().other().weakEquals(other.getBDDCouple())) {
	...
	public JTLVBDDCouple getBDDCouple() {
		return this.coup;
	}
