...
public class StructuralInit {
	...
	public SMVAbstractElementInfo add_module(String a_name, String[] args,
		...
		SMVModuleInfo m = this.all_modules.get(a_name);
		if (m != null) {
	...
	// phase 2 - define !!
	public SMVAbstractElementInfo mk_define_var(String var_name, IntStream input)
			throws SMVParseException {
	...
	public SMVModuleInfo get_module(String module_name, IntStream input)
			throws SMVParseException {
		SMVModuleInfo m = this.all_modules.get(module_name);
		if (m == null) {
...
//		try {
			...
			SMVMainProcVarInfo main_proc_info = new SMVMainProcVarInfo(
					main_info);
