...
public class AllTests {
	...
	public static Vector<String> get_all_file_name() {
		...
		// ret.add("testcases/mutex1.smv");
		//
		// ret.add("testcases/abp/abp10.smv");
		// ret.add("testcases/abp/abp11.smv");
		// ret.add("testcases/abp/abp16.smv");
		// ret.add("testcases/abp/abp4.smv");
		// ret.add("testcases/abp/abp8.smv");
		// ret.add("testcases/bmc/MCP.smv");
		// ret.add("testcases/bmc/barrel5.smv");
		// ret.add("testcases/bmc/counter.smv");
		// ret.add("testcases/bmc/dme/dme10.smv");
		// ret.add("testcases/bmc/dme/dme11.smv");
		// ret.add("testcases/bmc/dme/dme12.smv");
		// ret.add("testcases/bmc/dme/dme13.smv");
		// ret.add("testcases/bmc/dme/dme14.smv");
		// ret.add("testcases/bmc/dme/dme15.smv");
		// ret.add("testcases/bmc/dme/dme16.smv");
		// ret.add("testcases/bmc/dme/dme17.smv");
		// ret.add("testcases/bmc/dme/dme18.smv");
		// ret.add("testcases/bmc/dme/dme19.smv");
		// ret.add("testcases/bmc/dme/dme20.smv");
		// ret.add("testcases/bmc/dme/dme30.smv");
		// ret.add("testcases/bmc/dme/dme4.smv");
		// ret.add("testcases/bmc/dme/dme40.smv");
		// ret.add("testcases/bmc/dme/dme5.smv");
		// ret.add("testcases/bmc/dme/dme50.smv");
		// ret.add("testcases/bmc/dme/dme6.smv");
		// ret.add("testcases/bmc/dme/dme7.smv");
		// ret.add("testcases/bmc/dme/dme8.smv");
		// ret.add("testcases/bmc/dme/dme9.smv");
		// ret.add("testcases/bmc/multiplier.smv");
		// ret.add("testcases/bmc_tutorial/bmc_tutorial.smv");

		// /////////////////////////////////////////////////////////////////

		// ret.add("testcases/brp/brp.smv"); // this test is making a problem
		// ret.add("testcases/ctl-ltl/abp4.smv");
		// ret.add("testcases/ctl-ltl/abp8.smv");
		// ret.add("testcases/ctl-ltl/counter.smv");
		// ret.add("testcases/ctl-ltl/dme2.smv");
		// ret.add("testcases/ctl-ltl/guidance.smv");
		// ret.add("testcases/ctl-ltl/mutex.smv");
		// ret.add("testcases/ctl-ltl/mutex1.smv");
		// ret.add("testcases/ctl-ltl/p-queue.smv");
		// ret.add("testcases/ctl-ltl/periodic.smv"); // TC040
		// ret.add("testcases/ctl-ltl/prod-cons.smv");
		// ret.add("testcases/ctl-ltl/production-cell.smv");
		// ret.add("testcases/ctl-ltl/queue.smv");
		// ret.add("testcases/ctl-ltl/ring.smv");
		// ret.add("testcases/ctl-ltl/semaphore.smv");
		// ret.add("testcases/ctl-ltl/short.smv");
		// ret.add("testcases/ctl-ltl/syncarb5.smv"); // TC047

		// /////////////////////////////////

		// ret.add("testcases/deadlock/dartes.smv"); // TC048
		// ret.add("testcases/deadlock/dpd75.smv"); // TC049
		// ret.add("testcases/deadlock/dph35.smv"); // TC050
		// ret.add("testcases/deadlock/ftp3.smv"); // TC051
		// ret.add("testcases/deadlock/furnace17.smv"); // TC052
		// ret.add("testcases/deadlock/gas-nq7.smv");
		// ret.add("testcases/deadlock/key10.smv");
		// ret.add("testcases/deadlock/mmgt20.smv");
		// ret.add("testcases/deadlock/over12.smv"); // TC056

		// ret.add("testcases/example_cmu/counter.smv");
		// ret.add("testcases/example_cmu/dme1.smv");
		// ret.add("testcases/example_cmu/dme2.smv");
		// ret.add("testcases/example_cmu/gigamax.smv"); //TC060
		// ret.add("testcases/example_cmu/mutex.smv");
		// ret.add("testcases/example_cmu/mutex1.smv");
		// ret.add("testcases/example_cmu/periodic.smv"); // TC063
		// ret.add("testcases/example_cmu/ring.smv");
		// ret.add("testcases/example_cmu/semaphore.smv");
		// ret.add("testcases/example_cmu/short.smv");
		// ret.add("testcases/example_cmu/syncarb5.smv"); // TC067

		// ret.add("testcases/example_irst/dme4.smv");
		// ret.add("testcases/example_irst/dme5.smv");
		// ret.add("testcases/example_irst/dme6.smv"); //TC070
		// ret.add("testcases/example_irst/gigamax.smv");
		// ret.add("testcases/example_irst/gigamax_ltl.smv");
		// ret.add("testcases/example_irst/periodic.smv");

		// ret.add("testcases/guidance/guidance.smv");
		// ret.add("testcases/msi/msi_wtrans.smv");

		// ret.add("testcases/p-queue/p-queue.smv");
		// ret.add("testcases/pci/pci.smv"); // TC077
		// ret.add("testcases/prod-cons/prod-cons.smv"); // TC078
		// ret.add("testcases/production-cell/production-cell.smv");

		// ret.add("testcases/psl-samples/counter.smv"); // TC080
		// ret.add("testcases/psl-samples/dme2-16.smv");
		// ret.add("testcases/psl-samples/dme2.smv");
		// ret.add("testcases/psl-samples/gigamax.smv");
		// ret.add("testcases/psl-samples/ring.smv");
		// ret.add("testcases/psl-samples/semaphore.smv");
		// ret.add("testcases/psl-samples/short.smv");
		// ret.add("testcases/psl-samples/syncarb10.smv"); // TC087
		// ret.add("testcases/psl-samples/syncarb5.smv"); // TC088

		// ret.add("testcases/queue/queue.smv");
		// ret.add("testcases/reactor/base.smv"); // TC090
		// ret.add("testcases/reactor/idle.smv"); 

		// /////////////////////////////////

		// ret.add("testcases/smv-dist/counter.smv");
		// ret.add("testcases/smv-dist/dme1-16.smv");
		// ret.add("testcases/smv-dist/dme1.smv");
		// ret.add("testcases/smv-dist/dme2-16.smv");
		// ret.add("testcases/smv-dist/dme2.smv");
		// ret.add("testcases/smv-dist/gigamax.smv");
		// ret.add("testcases/smv-dist/mutex.smv");
		// ret.add("testcases/smv-dist/mutex1.smv");
		// ret.add("testcases/smv-dist/pci3p.smv"); // TC100
		// ret.add("testcases/smv-dist/pci4p.smv"); 
		// ret.add("testcases/smv-dist/periodic.smv"); // TC102
		// ret.add("testcases/smv-dist/ring.smv");
		// ret.add("testcases/smv-dist/robot.smv");
		// ret.add("testcases/smv-dist/semaphore.smv"); // TC105
		// ret.add("testcases/smv-dist/short.smv"); 
		// ret.add("testcases/smv-dist/syncarb10.smv");
		// ret.add("testcases/smv-dist/syncarb5.smv");

		// /////////////////////////////////

		// ret.add("testcases/tcas/tcas-t.smv"); // TC109
		// ret.add("testcases/tcas/tcas.smv");
