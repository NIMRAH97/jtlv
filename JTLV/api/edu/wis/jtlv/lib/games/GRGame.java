...
public class GRGame implements Game {
	public FDSModule env;
	public FDSModule sys;
	private BDD player2_winning;

	// p2_winning in GRGAmes are !p1_winning

	public GRGame(FDSModule env, FDSModule sys) throws IllegalGameException {
	...
	public FDSModule get_env_player() {
		return env;
	}

	public FDSModule get_sys_player() {
		return sys;
	}
